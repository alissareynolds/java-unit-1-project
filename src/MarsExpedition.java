...
public class MarsExpedition {
    ...
    public void startExpedition() {
        ...
        String teamLeaderChoice = input.nextLine();
        if (teamLeaderChoice.equalsIgnoreCase("Y")) {
        ...
        if (vehicleChoice.equalsIgnoreCase("A")) {
            ...
            vehicleChoice = "a Horse";
        } else {
            vehicleChoice = "your feet";
        }

        System.out.println("Your expedition team is now ready" +
                "\nLed by " + name + " with " + teamSize + " teammates" + " and a snack of " + snack + "." +
